...
extends h$_g
implements f {
    static final /* synthetic */ boolean \u00f5\u00d8O000;

    public h$_m(h h2, b.o.e.h h3) {
        if (h2 == null) {
            h$_m.newnew(0);
        }
        if (h3 == null) {
    ...
    static {
        \u00f5\u00d8O000 = !h.class.desiredAssertionStatus();
    }

    private static /* synthetic */ void newnew(int n2) {
