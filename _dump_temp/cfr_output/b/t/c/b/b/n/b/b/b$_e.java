...
import b.t.c.b.b.n.b.b.b$_e$1;
import b.t.c.b.b.n.b.b.b$_e$2;
...
implements j$_b {
    ...
    public void super(f object, Object object2) {
        ...
        if ("k".equals(object = ((f)object).\u00d400000())) {
            if (object2 instanceof Integer) {
                b.super(this.new, c$_b.o00000((Integer)object2));
                return;
            }
        } else if ("mv".equals(object)) {
            if (object2 instanceof int[]) {
                b.super(this.new, (int[])object2);
                return;
            }
        } else if ("xs".equals(object)) {
            if (object2 instanceof String && !((String)object2).isEmpty()) {
                b.super(this.new, (String)object2);
                return;
            }
        } else if ("xi".equals(object)) {
            if (object2 instanceof Integer) {
                b.super(this.new, (Integer)object2);
                return;
            }
        } else if ("pn".equals(object) && object2 instanceof String && !((String)object2).isEmpty()) {
            b.\u00d200000(this.new, (String)object2);
        }
    }
    ...
    private j$_f class() {
        return new b$_e$1(this);
    }

    private j$_f \u00d400000() {
        return new b$_e$2(this);
    }
